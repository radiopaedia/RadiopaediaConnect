...
const CaseDetailDrawer = ({ isOpen, onClose, caseId, zIndex = 50 }) => {
    ...
    // Fetch case details when drawer opens
    useEffect(() => {
        if (isOpen && caseId) {
            fetchCaseDetail();
        } else {
    ...
    const getRadiopaediaUrl = (radiopaediaCaseId) => {
        return `https://radiopaedia.org/cases/${radiopaediaCaseId}`;
    };
                                                ...
                                                <div className="grid grid-cols-2 gap-3 text-sm">
                                                    ...
                                                    {caseDetail.radiopaediaCaseId && (
                                                        <div className="col-span-2">
                                                            ...
                                                            <a
                                                                href={getRadiopaediaUrl(caseDetail.radiopaediaCaseId)}
                                                                target="_blank"
                                                                rel="noopener noreferrer"
                                                                className="ml-2 text-indigo-600 dark:text-indigo-400 font-mono hover:underline inline-flex items-center gap-1"
                                                            >
                                                                {caseDetail.radiopaediaCaseId}
